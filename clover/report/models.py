...
class ReportModel(CloverModel):
    ...
    interface = db.Column(db.Integer, default=0, comment="测试接口个数")
    verify = db.Column(db.Integer, default=0, comment="测试断言个数")
    percent = db.Column(db.Float, default=0.0, comment="测试通过率")
